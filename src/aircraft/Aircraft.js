...
export class Aircraft {
    ...
    throttle = AIRCRAFT.START_THROTTLE;
    ...
    update(dt, input, floatingOrigin) {
        if (this.crashed)
            return; // физика заморожена до reset() — см. AircraftController (клавиша R)
        ...
        const deltaRotation = new THREE.Quaternion().setFromEuler(new THREE.Euler(pitchAngle, yawAngle, -rollAngle, 'XYZ'));
