...
export class Renderer {
    ...
    applyQuality(pixelRatioCap, shadowsEnabled) {
...
export function createMainCamera() {
    const camera = new THREE.PerspectiveCamera(RENDER.FOV_DEGREES, window.innerWidth / window.innerHeight, RENDER.NEAR_PLANE, RENDER.FAR_PLANE);
