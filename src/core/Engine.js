...
export class Engine {
    ...
    constructor(container) {
        ...
        this.renderer.applyQuality(this.qualityManager.currentTier.pixelRatioCap, this.qualityManager.currentTier.shadowsEnabled);
        this.floatingOrigin = new FloatingOrigin();
        this.chunkManager = new ChunkManager(this.scene, this.floatingOrigin, this.qualityManager.currentTier.lodRingRadiusMeters);
        this.water = new Water();
        this.scene.add(this.water.mesh);
        this.aircraftController = new AircraftController(this.floatingOrigin, new TerrainNoise(NOISE.SEED));
    ...
    loop = () => {
        ...
        const anchorWorldPos = this.floatingOrigin.getWorldPosition(this.aircraftController.aircraft.group);
        ...
        this.sunLight.position.set(this.aircraftController.aircraft.group.position.x + this.sky.getSunDirection().x * 2000, this.sky.getSunDirection().y * 2000, this.aircraftController.aircraft.group.position.z + this.sky.getSunDirection().z * 2000);
